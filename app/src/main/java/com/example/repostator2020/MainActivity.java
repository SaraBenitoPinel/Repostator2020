...
public class MainActivity extends AppCompatActivity {
    ...
    public void onStart(){
        super.onStart();
        ArrayList<String> listadoRepostajes = new ArrayList<String>(); //CREO LA LISTA DONDE GUARDO MIS REPOSTAJES
        ListView listaVista;
        ...
        int size = sp.getInt("listado_size", 0); //EL TAMAÑO DE LA LISTA DE RESPOSTAJES QUE HEMOS HECHO
        String precio = "";
        String kilometros = "";
        String litros = "";
        String dia = "";
